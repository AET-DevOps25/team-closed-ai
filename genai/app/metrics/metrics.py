...
generation_time_histogram = Histogram(
    "genai_generation_time_seconds", "Time spent on task generation", registry=REGISTRY
)

answering_time_histogram = Histogram(
    "genai_answering_time_seconds", "Time spent on answering tasks", registry=REGISTRY
)
