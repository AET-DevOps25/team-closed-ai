...
class ProjectApi:
    ...
    def add_task_to_project(
        ...
        :param id: (required)
        :type id: int
        :param add_task_dto: (required)
        :type add_task_dto: AddTaskDto
    ...
    def _add_task_to_project_serialize(
        ...
        if add_task_dto is not None:
            _body_params = add_task_dto
