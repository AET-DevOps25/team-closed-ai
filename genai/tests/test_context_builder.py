...
class TestBuildProjectContext:
    ...
    def test_build_project_context_success(
        self, mock_get_vectorizers, mock_register, mock_connect, mock_dependencies
    ):
        # Arrange
    ...
    @patch("chain.context_builder.get_vectorizers")
    @patch.dict(os.environ, {"DATABASE_URL": "test://db"})
    def test_build_project_context_no_project_vectorizer(
        self, mock_get_vectorizers, mock_register, mock_connect, mock_dependencies
    ):
        # Arrange
        project_id = "test_project_123"
    ...
    @patch("chain.context_builder.get_vectorizers")
    @patch.dict(os.environ, {"DATABASE_URL": "test://db"})
    def test_build_project_context_with_none_chunks(
        self, mock_get_vectorizers, mock_register, mock_connect, mock_dependencies
    ):
        # Arrange
        project_id = "test_project_123"
...
class TestBuildTaskContext:
    ...
    @patch("chain.context_builder.get_vectorizers")
    @patch.dict(os.environ, {"DATABASE_URL": "test://db"})
    def test_build_task_context_success_with_descriptions(
        self, mock_get_vectorizers, mock_register, mock_connect, mock_dependencies
    ):
        # Arrange
        project_id = "test_project_123"
    ...
    @patch("chain.context_builder.get_vectorizers")
    @patch.dict(os.environ, {"DATABASE_URL": "test://db"})
    def test_build_task_context_no_task_vectorizer(
        self, mock_get_vectorizers, mock_register, mock_connect, mock_dependencies
    ):
        # Arrange
        project_id = "test_project_123"
    ...
    @patch("chain.context_builder.get_vectorizers")
    @patch.dict(os.environ, {"DATABASE_URL": "test://db"})
    def test_build_task_context_empty_results(
        self, mock_get_vectorizers, mock_register, mock_connect, mock_dependencies
    ):
        # Arrange
        project_id = "test_project_123"
...
class TestBuildContext:
    ...
    def test_build_context_success_with_user_id(
        self,
        mock_vector,
        mock_build_task,
        mock_build_project,
    ...
    @patch("chain.context_builder._build_task_context")
    @patch("chain.context_builder.Vector")
    def test_build_context_success_without_user_id(
        self,
        mock_vector,
        mock_build_task,
        mock_build_project,
    ...
    def test_build_context_project_error_handling(
        self,
        mock_print,
        mock_vector,
        mock_build_task,
        ...
        mock_print.assert_called_once_with(
            "Error building project context: Project context error"
        )
    ...
    @patch("chain.context_builder.Vector")
    @patch("builtins.print")
    def test_build_context_task_error_handling(
        self,
        mock_print,
        mock_vector,
        mock_build_task,
        ...
        assert result == expected
        mock_print.assert_called_once_with(
            "Error building task context: Task context error"
        )
    ...
    @patch("chain.context_builder.Vector")
    @patch("builtins.print")
    def test_build_context_both_errors(
        self,
        mock_print,
        mock_vector,
        mock_build_task,
