...
def test_answer_and_reference(mock_config, mock_api_client, mock_task_api, mock_build_context, mock_answer_chain):
    # Arrange
    ...
    mock_build_context.assert_called_once_with(request.project_id, request.user_id, request.prompt)
