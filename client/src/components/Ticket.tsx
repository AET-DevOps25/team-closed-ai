import { useState, type ClassAttributes, type HTMLAttributes, type LegacyRef} from "react";
      ...
      <>
        <Draggable draggableId={ticket.id} index={index}>
          {(provided: {
            ...
            draggableProps: JSX.IntrinsicAttributes & ClassAttributes<HTMLDivElement> & HTMLAttributes<HTMLDivElement>;
            dragHandleProps: JSX.IntrinsicAttributes & ClassAttributes<HTMLDivElement> & HTMLAttributes<HTMLDivElement>;
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  ...
                  <Badge variant="secondary" className={`text-xs ${getStateColor(ticket.state)}`}>
        ...
        <ViewTicketDialog isOpen={isDialogOpen} onClose={closeDialog} ticketId={ticket.id} />
      </>
  );
};
